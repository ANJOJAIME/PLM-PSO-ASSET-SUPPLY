        ...
        <div class="container">
            <div class="table-container">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @foreach ($dasset as $delivery)
                            <tr>
                                <td>{{ $delivery->d_item_no }}</td>
                                <td>{{ $delivery->d_description }}</td>
                                <td>{{ $delivery->d_po_no }}</td>
                                <td>
                                    <a href="{{ route('pages.delivery.recover', ['id' => $delivery->id]) }}" class="btn-recover">Recover</a>
                                    <form method="POST" action="{{ route('pages.delivery.forceDelete', ['id' => $delivery->id]) }}">
                                        @csrf
                                        @method('DELETE')
